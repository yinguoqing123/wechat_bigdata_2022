...
class UniBert(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, mask=None, token_type_ids=None, gather_index=None, inputs_embeds=None, modal_type='text', frame_mask=None, 
        ...
        output_embeddings_frame = self.encoder(frame_embeddings, self.get_extended_mask(frame_mask))['last_hidden_state']
        ...
        union_output_embeddings = self.encoder(union_embeddings, mask, start_layer=0, end_layer=12)['last_hidden_state']
        # output_embeddings_text, output_embeddings_frame = union_output_embeddings[:, :text_embeddings.shape[1], :], union_output_embeddings[:, text_embeddings.shape[1]:, :]
        output = dict(
